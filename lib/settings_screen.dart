      ...
      child: Column(
        ...
        children: [
          ...
          ListTile(
            ...
            title: Text("Dr .Doctor Name",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 25),),
          ...
          ListTile(
            ...
            title: Text("Notifications",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20),
            ),
            trailing: Icon(Icons.arrow_forward_ios_rounded),
          ),
          SizedBox(height: 20,),
          ...
          ListTile(
            ...
            leading: Container(
              ...
              child: Icon(Icons.settings_suggest_outlined,color: Colors.green,size: 35,),
            ),
          ...
          ListTile(
            ...
            leading: Container(
              ...
              child: Icon(Icons.info_outline,color: Colors.orange,size: 35,),
            ),
