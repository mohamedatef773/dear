                            ...
                            child: Column(
                              children: [
                                ...
                                Padding(padding: EdgeInsets.symmetric(horizontal: 10),
                                  child: Text(
                                    "Many thanks to Dr. Dear . He is a great and proffessional",style: TextStyle(color: Colors.black),),)
                              ],
                            ),
                          ) ,
                        );
        ...
        child:Column(
          children: [
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Coultation price",style: TextStyle(color: Colors.black54),),
